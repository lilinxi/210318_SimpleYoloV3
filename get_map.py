...
GT_PATH = os.path.join(os.getcwd(), 'map_input', 'ground_truth')
DR_PATH = os.path.join(os.getcwd(), 'map_input', 'detection_result')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'map_input', 'images_optional')
